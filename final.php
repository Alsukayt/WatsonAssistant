...
if(isset($_POST['save'])){
    ...
    $my_query = "select * from motorvalues WHERE 1 ";
    $result = mysqli_query($connection, $my_query);

    $my_query = "INSERT INTO motorvalues (Motor1, Motor2, Motor3, Motor4, Motor5, Motor6) VALUES ('$Motor1', '$Motor2', '$Motor3', '$Motor4', '$Motor5', '$Motor6')";
    $result = mysqli_query($connection, $my_query);
    if($result)
    {
    ...
    $my_query = "INSERT INTO off_values (isOff) VALUES (1)";
    $result = mysqli_query($connection, $my_query);
    if($result)
    {
        echo "Item successfuly Added!";
